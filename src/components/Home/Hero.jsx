  ...
  return (
    ...
    <>
      <div className="relative min-h-screen flex items-center justify-center text-white">
        ...
        <div className="absolute inset-0 bg-[url(https://i.ibb.co/whvHStsp/photo-1504674900247-0877df9cc836-q-80-w-2940-auto-format-fit-crop-ixlib-rb-4-0.jpg)] bg-cover bg-center bg-no-repeat z-0">
